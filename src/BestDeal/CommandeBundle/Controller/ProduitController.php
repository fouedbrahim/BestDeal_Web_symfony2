...
use BestDeal\CommandeBundle\Form\ProduitType;
...
class ProduitController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BestDealMainBundle:Produit')->findAll();
        $entities1 = $em->getRepository('BestDealMainBundle:Tempproduit')->findAll();
        return $this->render('BestDealCommandeBundle:Produit:index.html.twig', array(
            'entities' => $entities,
            'entities1' => $entities1,
        ));
    }
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BestDealMainBundle:Produit')->find($id);
        ...
        return $this->render('BestDealCommandeBundle:Produit:show.html.twig', array(
            'entity'      => $entity,
